        ...
        <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
            <div className="bg-zinc-900 p-8 rounded-xl shadow-sm w-full max-w-md border border-zinc-800">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white tracking-wider">BARBER<span className="text-amber-500">PRO</span></h1>
                    <p className="text-sm text-zinc-400 mt-2">Gestão exclusiva para barbearias de alto padrão.</p>
                </div>
                {/* Formulário */}
                <form onSubmit={submitForm} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" placeholder="contato@suabarbearia.com"
                ...
                <div className="mt-6 text-center text-sm text-zinc-500">
                    Problemas para acessar? <a href="#" className="text-amber-500 hover:underline">Fale com o suporte</a>
                </div>
            </div>
        </div>
    )
